...
import os
execfile(os.path.join("gordonweb", "release.py"))

packages=find_packages()
package_data = find_package_data(where='gordonweb',
    package='gordonweb')
...
setup(
    ...
    entry_points = {
        'console_scripts': [
            'start-gordonweb = gordonweb.command:start',
            # See the gordonweb.command.bootstrap function for details
